    ...
    <section className="advantages">
      <div className="container advantages__wrapper">
        <div className="advantages__sticky-wrapper">
          <h2 className="text-type-2 advantages__title">Преимущества</h2>
        </div>
        <div className="advantages__col-wrapper">
          ...
          <div className="advantages__card">
            <h3 className="font-weight-medium text-type-3 advantages__label">Удобно</h3>
            <p className="font-weight-medium text-type-6 advantages__description">
          ...
          <div className="advantages__card">
            <h3 className="font-weight-medium text-type-3 advantages__label">Доступно</h3>
            <p className="font-weight-medium text-type-6 advantages__description">
          ...
          <div className="advantages__card">
            <h3 className="font-weight-medium text-type-3 advantages__label">Эффективно</h3>
            <p className="font-weight-medium text-type-6 advantages__description">
