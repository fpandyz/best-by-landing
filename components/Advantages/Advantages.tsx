  ...
  return (
    <section className="advantages">
      <div className="container advantages__wrapper">
        ...
        <div className="font-family-1 advantages__col-wrapper">
          <div className="advantages__card">
            <h3 className="text-type-3 advantages__label">Надёжно</h3>
            <p className="text-type-6 advantages__description">
          ...
          <div className="advantages__card">
            <h3 className="text-type-3 advantages__label">Удобно</h3>
            <p className="text-type-6 advantages__description">
          ...
          <div className="advantages__card">
            <h3 className="text-type-3 advantages__label">Доступно</h3>
            <p className="text-type-6 advantages__description">
          ...
          <div className="advantages__card">
            <h3 className="text-type-3 advantages__label">Гибко</h3>
            <p className="text-type-6 advantages__description">
          ...
          <div className="advantages__card">
            <h3 className="text-type-3 advantages__label">Эффективно</h3>
            <p className="text-type-6 advantages__description">
